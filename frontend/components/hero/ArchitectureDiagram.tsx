  ...
  return (
    <div className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 shadow-md shadow-zinc-900/5 dark:shadow-none overflow-hidden font-sans text-zinc-900 dark:text-zinc-100">
      ...
      <div className="p-4 min-h-[300px] flex flex-col justify-between">
        ...
        {activeTab === "topology" && (
          <div className="space-y-3">
            ...
            <div
              ...
              className={`p-2.5 rounded-lg border transition-all cursor-pointer bg-white dark:bg-zinc-900/80 ${
                selectedNode === "client"
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-md bg-sky-500/10 border border-sky-500/20 flex items-center justify-center text-sky-600 dark:text-sky-400">
                    <Code2 className="w-3.5 h-3.5" />
                  </div>
                  <div>
                    <span className="text-xs font-mono font-bold text-zinc-900 dark:text-zinc-100 block leading-tight">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div
                ...
                className={`p-2 rounded-lg border text-center transition-all cursor-pointer bg-white dark:bg-zinc-900/80 ${
                  selectedNode === "database"
                    ? "border-emerald-500 ring-1 ring-emerald-500/30 shadow-xs"
                    : "border-zinc-200 dark:border-zinc-800 hover:border-emerald-400"
                }`}
              >
                <div className="w-5 h-5 mx-auto mb-1 rounded bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
              ...
              >
                <div className="w-5 h-5 mx-auto mb-1 rounded bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-600 dark:text-amber-400">
              ...
              >
                <div className="w-5 h-5 mx-auto mb-1 rounded bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
        ...
        {activeTab === "services" && (
          <div className="space-y-3">
            <div className="space-y-2 text-xs font-mono">
              {/* FastAPI Gateway */}
              <div className="p-2.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded bg-sky-500/10 border border-sky-500/20 flex items-center justify-center text-sky-600 dark:text-sky-400">
                    <Server className="w-3.5 h-3.5" />
                  </div>
                  <div>
              ...
              <div className="p-2.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
              ...
              <div className="p-2.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-600 dark:text-amber-400">
              ...
              <div className="p-2.5 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50/70 dark:bg-zinc-900/50 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400">
        ...
        {activeTab === "logs" && (
          <div className="flex flex-col h-[280px]">
            <div
              ...
              className="flex-1 overflow-y-auto font-mono text-[11px] leading-relaxed p-3 rounded-lg bg-zinc-950 text-zinc-300 border border-zinc-800 space-y-1.5 select-text"
            >
              {events.length === 0 ? (
                ...
                events.map((ev, i) => (
                  <div key={`${ev.timestamp}-${i}`} className="flex items-start gap-2">
                    ...
                    <span className="text-sky-400 font-bold uppercase text-[10px] shrink-0">
                      [{ev.type}]
                    </span>
                    ...
                    {ev.duration_ms && (
                      <span className="text-zinc-500 text-[10px] ml-auto shrink-0 font-mono">
                        {ev.duration_ms}ms
                      </span>
                    )}
                  </div>
        ...
        {activeTab === "latency" && (
          <div className="space-y-4">
            ...
            {hasLatencyData ? (
              ...
              <div className="h-20 flex items-center justify-center text-zinc-500 text-xs font-mono">
            ...
            {hasLatencyData && (
              <div className="grid grid-cols-4 gap-2 text-center text-xs font-mono p-2 rounded-md border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60">
                <div>
                  <span className="text-[10px] text-zinc-500 block">LATEST</span>
                  <strong className="text-sky-600 dark:text-sky-400">{latestLatency}ms</strong>
                </div>
                <div>
                  <span className="text-[10px] text-zinc-500 block">MIN</span>
                  <strong className="text-zinc-900 dark:text-zinc-100">{minLatency}ms</strong>
                </div>
                <div>
                  <span className="text-[10px] text-zinc-500 block">AVG</span>
                  <strong className="text-zinc-900 dark:text-zinc-100">{avgLatency}ms</strong>
                </div>
                <div>
                  <span className="text-[10px] text-zinc-500 block">MAX</span>
                  <strong className="text-zinc-900 dark:text-zinc-100">{maxLatency}ms</strong>
                </div>
              </div>
            )}
          </div>
        ...
        {/* Panel Footer */}
        <div className="pt-3 border-t border-zinc-100 dark:border-zinc-900 flex items-center justify-between text-[10px] font-mono text-zinc-500">
