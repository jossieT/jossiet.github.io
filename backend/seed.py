...
PROJECTS = [
    ...
    "technologies": [
        "Node.js", "Express.js", "MongoDB", "Mongoose", "Cloudinary", "Joi",
...
graph TD
    ...
    """,
    "architecture_steps": [
        {"title": "Customer / Admin Interaction", "description": "Users interact with the platform through a React-based frontend or a dedicated Admin Dashboard, initiating requests to the backend REST API."},
        {"title": "API Gateway & Load Balancing", "description": "Requests are routed through a load balancer/API Gateway to the Node.js/Express backend, ensuring scalability and distribution."},
        {"title": "Backend API (Node.js / Express.js)", "description": "The core application logic, built with Node.js and Express.js, processes all incoming requests."},
        {"title": "Request Validation & Security", "description": "All incoming data undergoes rigorous validation with Joi, coupled with JWT authentication and rate limiting to secure API endpoints."},
        {"title": "Controllers & Services", "description": "Modularized controllers handle routing and delegate business logic to services for data manipulation and complex operations."},
        {"title": "Data Persistence (MongoDB / Mongoose)", "description": "MongoDB, managed via Mongoose ORM, serves as the primary database for storing all operational data, including bookings, users, services, and staff information."},
        {"title": "Media Management (Cloudinary)", "description": "Integrated with Cloudinary for secure storage, optimization, and delivery of vehicle image documentation associated with bookings."},
        {"title": "Logging & Monitoring (Winston)", "description": "Winston is implemented for comprehensive application logging, enabling effective monitoring, debugging, and operational insights."}
    ],
    "tech_stack_grouped": {
        "frontend": [
            {"name": "React", "purpose": "JavaScript library for building user interfaces for the Admin Dashboard."}
        ],
        "backend": [
        ...
        "database": [
            {"name": "MongoDB", "purpose": "NoSQL document database for flexible data storage."},
            {"name": "MongoDB Atlas", "purpose": "Cloud-hosted MongoDB service for scalability and reliability."},
        ...
        "security": [
            {"name": "JWT Authentication", "purpose": "Token-based authentication for securing API endpoints."},
            {"name": "Rate Limiting", "purpose": "Protects API from abuse and ensures fair usage."},
            {"name": "Security Headers", "purpose": "Enhances application security against common web vulnerabilities."}
        ],
        "media": [
            {"name": "Cloudinary", "purpose": "Cloud-based image and video management for vehicle documentation."}
        ],
        "logging": [
            {"name": "Winston", "purpose": "Versatile logging library for structured application logs."}
        ],
        "admin": [
            {"name": "React", "purpose": "Frontend framework for the administrative dashboard UI."},
            {"name": "Node.js/Express.js", "purpose": "Backend API powers the admin dashboard's data interactions."}
        ],
        "infrastructure": [], # Not enough info to detail specific infra
        "deployment": [] # Not enough info to detail specific deployment
    },
    "key_features": [
        {"title": "Dynamic Booking & Real-time Availability", "description": "Customers can select services, packages, and available time slots with immediate feedback on staff and resource availability.", "status": "Completed"},
        {"title": "Staff Scheduling & Management", "description": "Comprehensive tools for staff registration, defining working hours, managing shifts, and processing day-off requests, directly impacting booking availability.", "status": "Completed"},
        {"title": "React Administrative Dashboard", "description": "A dedicated React-based web interface for administrators to manage bookings, services, staff, pricing, configurations, and review operational metrics.", "status": "Completed"},
        {"title": "Vehicle Media Documentation", "description": "Integration with Cloudinary enables secure upload, storage, and association of vehicle images with specific booking records, crucial for quality control and dispute resolution.", "status": "Completed"},
        {"title": "Flexible Service & Pricing Configuration", "description": "Admins can define multiple service packages, add-ons, and dynamic pricing rules to accommodate various customer needs.", "status": "Completed"},
        {"title": "Centralized Operational Management", "description": "Provides a single source of truth for all business operations, including booking status tracking, customer details, and service histories.", "status": "Completed"}
    ],
    ...
    "security_reliability": [
        {"title": "Joi Request Validation", "description": "Ensures all incoming API requests conform to expected data schemas, preventing malformed data and common injection attacks.", "icon_name": "CheckCircle2"},
        {"title": "Centralized Error Handling", "description": "Implemented global error handling middleware to catch and manage exceptions consistently, providing meaningful error responses without exposing sensitive internal details.", "icon_name": "AlertTriangle"},
        {"title": "Rate Limiting", "description": "Protects API endpoints from brute-force attacks and excessive requests, ensuring service availability and fair usage for all clients.", "icon_name": "Shield"},
        {"title": "Security Headers", "description": "Configured HTTP security headers (e.g., CORS, X-Content-Type-Options) to mitigate common web vulnerabilities and enhance client-side security.", "icon_name": "Lock"},
        {"title": "JWT Authentication", "description": "Secured sensitive API routes with JSON Web Token (JWT) based authentication for both customer and admin users, ensuring authenticated access control.", "icon_name": "Key"},
        {"title": "MongoDB Indexing", "description": "Implemented appropriate MongoDB indexes on frequently queried fields (e.g., booking dates, user IDs, service types) to optimize database query performance and scalability.", "icon_name": "Database"}
    ],
    "results": [
...
flowchart TD
    ...
    """,
    "architecture_steps": [
        {"title": "Data Preparation", "description": "The CFPB consumer complaint dataset undergoes rigorous cleaning and filtering to extract useful complaint narratives, removing noise and standardizing formats for subsequent processing."},
        {"title": "Semantic Representation", "description": "Each cleaned complaint text chunk is transformed into a 384-dimensional numerical vector (embedding) using the `sentence-transformers/all-MiniLM-L6-v2` model, capturing its semantic meaning."},
        {"title": "Vector Indexing", "description": "The generated embeddings are efficiently stored and indexed using FAISS (Facebook AI Similarity Search), enabling rapid similarity queries across the large dataset."},
        {"title": "Retrieval", "description": "When an analyst poses a question, it is first converted into an embedding. This query embedding is then matched against the FAISS index to semantically retrieve the most relevant complaint excerpts (evidence)."},
        {"title": "Grounded Generation", "description": "The retrieved complaint evidence is fed into a `google/flan-t5-small` language model. This model generates a concise answer that is 'grounded' or supported by the provided evidence, reducing hallucinations."},
        {"title": "Evidence-Based Interface", "description": "A Gradio-based user interface presents the generated answer to the analyst along with the exact raw complaint excerpts that were used as evidence, ensuring transparency and trustworthiness."}
    ],
    "tech_stack_grouped": {
        "data_processing": [
            {"name": "Python", "purpose": "Primary programming language for the entire RAG pipeline."},
            {"name": "Pandas", "purpose": "Data manipulation and analysis for preprocessing the CFPB dataset."}, # Verified in instructions
            {"name": "NumPy", "purpose": "Numerical computing for handling data arrays and embeddings."} # Verified in instructions
        ],
        "embeddings": [
            {"name": "sentence-transformers/all-MiniLM-L6-v2", "purpose": "Converts text into 384-dimensional dense vector embeddings."}
        ],
        "retrieval": [
            {"name": "FAISS", "purpose": "Efficient library for similarity search and clustering of dense vectors."}
        ],
        "generation": [
            {"name": "google/flan-t5-small", "purpose": "Transformer-based language model for generating grounded answers."}
        ],
        "application": [
            {"name": "Gradio", "purpose": "Python library for creating customizable UI components for ML models."}
        ],
        "evaluation": [
            {"name": "Custom Evaluation Scripts", "purpose": "Python scripts for benchmarking retrieval performance."},
            {"name": "Documented Benchmark", "purpose": "Specific business questions used for evaluating the RAG system."},
        ]
    },
    "key_features": [
        {"title": "Large-Scale Complaint Indexing", "description": "Processed and indexed 1.37 million CFPB consumer complaints, making them semantically searchable.", "status": "Completed"},
        {"title": "Semantic Retrieval", "description": "Uses dense sentence embeddings and FAISS similarity search to retrieve semantically relevant complaint evidence, overcoming keyword limitations.", "status": "Completed"},
        {"title": "Grounded Answer Generation", "description": "Generates concise answers from retrieved complaint context rather than relying solely on the language model's internal knowledge, improving factual accuracy.", "status": "Completed"},
        {"title": "Evidence Panel", "description": "The user interface explicitly displays the complaint excerpts that support the generated response, enhancing transparency and analyst trust.", "status": "Completed"},
        {"title": "Retrieval Evaluation", "description": "Achieved a 100% retrieval rate on the documented benchmark, where the top-5 relevant chunks were found for all benchmark questions.", "status": "Completed"}
    ],
    "engineering_decisions": [
        {
    ...
    "security_reliability": [
        {"title": "Persisted FAISS Index", "description": "The FAISS vector index is persisted to disk, ensuring data durability and rapid reloading for continuous operation without re-indexing the entire dataset.", "icon_name": "Save"},
        {"title": "Deterministic Preprocessing", "description": "The data preprocessing pipeline is designed to be deterministic, ensuring consistent embeddings and retrieval results for identical input data.", "icon_name": "RefreshCcw"},
        {"title": "Evaluation Pipeline", "description": "A dedicated evaluation framework and benchmark (CFPB complaints, business questions, retrieval rate metric) ensure the system's performance is measurable and auditable.", "icon_name": "BarChart3"},
        {"title": "Evidence Visibility", "description": "The Gradio interface explicitly displays the raw complaint excerpts used to formulate answers, allowing human analysts to verify the grounding and build trust in the system.", "icon_name": "Eye"},
        {"title": "Separation of Concerns", "description": "The RAG pipeline components (preprocessing, indexing, retrieval, generation, UI) are logically separated, enhancing modularity, maintainability, and testability.", "icon_name": "Layers"}
    ],
    "results": [
...
graph TD
    ...
    """,
    "architecture_steps": [
        {"title": "Authentication & Authorization", "description": "Implements JWT-based authentication with refresh tokens and role-based access control for USER, CREATOR, and ADMIN roles."},
        {"title": "Content Management", "description": "Provides structured REST APIs for managing Christian articles, devotionals, and other digital content."},
        {"title": "Digital Book Store", "description": "Provides backend services for digital book catalog and related user access functionality."},
        {"title": "User Library & Reading Progress", "description": "Maintains user library state and reading progress through relational PostgreSQL data models managed by Prisma."},
        {"title": "Data Access Layer", "description": "Uses Prisma ORM with PostgreSQL to provide typed database access, schema migrations, and relational data management."},
        {"title": "Caching / Session Infrastructure", "description": "Uses Redis for caching and session management within the platform to enhance performance and responsiveness."}
    ],
    "tech_stack_grouped": {
        "backend": [
            {"name": "NestJS 11", "purpose": "Modular, scalable Node.js framework for building REST APIs."},
            {"name": "Node.js", "purpose": "JavaScript runtime environment."},
            {"name": "TypeScript", "purpose": "Superset of JavaScript for type-safe development."}
        ],
        "database": [
            {"name": "PostgreSQL", "purpose": "Primary relational database for structured data storage."},
            {"name": "Neon", "purpose": "Serverless PostgreSQL for scalable and managed database infrastructure."},
            {"name": "Prisma 6", "purpose": "ORM and database access layer for type-safe queries and schema migrations."}
        ],
        "caching": [
            {"name": "Redis", "purpose": "In-memory data store for caching and session management."}
        ],
        "authentication_security": [
            {"name": "JWT", "purpose": "JSON Web Tokens for secure API authentication."},
            {"name": "Refresh Tokens", "purpose": "Mechanism for securely renewing access tokens."},
            {"name": "RBAC", "purpose": "Role-Based Access Control for managing user permissions (USER, CREATOR, ADMIN)."}
        ],
        "infrastructure": [
            {"name": "Docker", "purpose": "Containerization for consistent development and deployment environments."},
            {"name": "Docker Compose", "purpose": "Tool for defining and running multi-container Docker applications locally."}
        ],
        "api": [
            {"name": "Swagger / OpenAPI", "purpose": "Automatic generation of interactive API documentation."},
            {"name": "API Versioning", "purpose": "Versioned REST API endpoints under `/api/v1`."}
        ]
    },
    "key_features": [
        {"title": "JWT Authentication & Refresh Tokens", "description": "Secure user authentication with JWT access tokens and long-lived refresh tokens.", "status": "Completed"},
        {"title": "Role-Based Access Control", "description": "Granular permissions for USER, CREATOR, and ADMIN roles across API resources.", "status": "Completed"},
        {"title": "Christian Articles & Devotionals", "description": "APIs for managing and retrieving diverse Christian content, including articles and daily devotionals.", "status": "Completed"},
        {"title": "Digital Book Catalog", "description": "Structured management of digital book metadata and availability within the platform's store.", "status": "Completed"},
        {"title": "User Digital Library", "description": "Functionality to manage user-owned or accessible digital content libraries.", "status": "Completed"},
        {"title": "Reading Progress Tracking", "description": "APIs for recording and syncing user reading progress within digital content.", "status": "Completed"},
        {"title": "Swagger/OpenAPI Documentation", "description": "Automatically generated, interactive API documentation for easy developer integration and testing.", "status": "Completed"},
        {"title": "API Versioning", "description": "Maintained API stability and evolution with explicit versioning under /api/v1.", "status": "Completed"}
    ],
    "engineering_decisions": [
        {
    ...
    "security_reliability": [
        {"title": "JWT Authentication", "description": "Secured all API endpoints using JSON Web Tokens to verify user identity and prevent unauthorized access.", "icon_name": "Key"},
        {"title": "Refresh Token Mechanism", "description": "Implemented refresh token rotation to enhance security and provide a seamless user experience for prolonged sessions.", "icon_name": "RefreshCcw"},
        {"title": "Role-Based Access Control (RBAC)", "description": "Enforced granular permissions based on user roles (USER, CREATOR, ADMIN) to control access to specific functionalities and data.", "icon_name": "ShieldCheck"},
        {"title": "DTO & Request Validation", "description": "Utilized DTOs (Data Transfer Objects) with class-validator to ensure all incoming API requests conform to predefined schemas, mitigating data integrity issues and common attack vectors.", "icon_name": "CheckSquare"},
        {"title": "Protected Routes & Guards", "description": "Implemented NestJS Guards to protect sensitive API routes, ensuring only authenticated and authorized users can access them.", "icon_name": "Lock"},
        {"title": "Relational Database Constraints", "description": "Leveraged PostgreSQL's relational capabilities and Prisma's schema definitions to enforce data integrity through foreign keys, unique constraints, and referential actions.", "icon_name": "Database"},
        {"title": "Prisma Migrations", "description": "Managed database schema evolution using Prisma Migrations, ensuring consistency between the application's data models and the PostgreSQL database.", "icon_name": "Code"}
    ],
    "results": [
